...
const ARCHITECTURE_TEMPLATES: ArchitectureTemplate[] = [
  {
    ...
    description: 'Static website with serverless backend. This template showcases a basic serverless architecture, providing a foundation for building scalable web applications.',
    category: 'Web Applications',
    services: [
      { serviceName: 'S3', x: 100, y: 100, label: 'Static Website' },
      { serviceName: 'CloudFront', x: 100, y: 200, label: 'CDN' },
      { serviceName: 'API Gateway', x: 300, y: 150, label: 'REST API' },
      { serviceName: 'Lambda', x: 500, y: 150, label: 'Business Logic' },
      { serviceName: 'DynamoDB', x: 700, y: 150, label: 'Database' },
    ],
    connections: [
      { from: 'CloudFront', to: 'S3', type: 'network', label: 'Serves' },
      { from: 'API Gateway', to: 'CloudFront', type: 'network', label: 'API Calls' },
  ...
  },
  {
    ...
    description: 'Container-based microservices with load balancing. Ideal for complex applications, this template demonstrates a microservices pattern with containerization and managed load balancing.',
    category: 'Enterprise',
    services: [
      { serviceName: 'ALB', x: 100, y: 150, label: 'Load Balancer' },
      { serviceName: 'ECS', x: 300, y: 100, label: 'User Service' },
      { serviceName: 'ECS', x: 300, y: 200, label: 'Order Service' },
      { serviceName: 'RDS', x: 500, y: 100, label: 'User DB' },
      { serviceName: 'RDS', x: 500, y: 200, label: 'Order DB' },
    ],
    connections: [
      { from: 'ALB', to: 'ECS', type: 'network', label: 'Routes' },
  ...
  },
  {
    ...
    description: 'ETL pipeline for big data processing. This template builds an end-to-end data pipeline, showcasing data ingestion, transformation, and analytics using managed AWS services.',
    category: 'Analytics',
    services: [
      { serviceName: 'S3', x: 100, y: 150, label: 'Raw Data' },
      { serviceName: 'Kinesis', x: 300, y: 150, label: 'Stream' },
      { serviceName: 'Lambda', x: 500, y: 150, label: 'Transform' },
      { serviceName: 'Redshift', x: 700, y: 150, label: 'Data Warehouse' },
      { serviceName: 'QuickSight', x: 900, y: 150, label: 'Analytics' },
    ],
    connections: [
      { from: 'S3', to: 'Kinesis', type: 'data', label: 'Ingests' },
      { from: 'Kinesis', to: 'Lambda', type: 'async', label: 'Triggers' },
      { from: 'Lambda', to: 'Redshift', type: 'data', label: 'Loads' },
